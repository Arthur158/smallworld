...
func GeneratedMap(gs *GameState) map[string]*Tile {
    // Generated by the browser map generator.
    // This contains only map topology/metadata. Game-specific setup
    // such as Lost Tribe placement can be added after this block.

    tileMap := map[string]*Tile{
        "0": {Id: "0", Biome: Hill, Attributes: []Attribute{}},
        "1": {Id: "1", Biome: Mountain, Attributes: []Attribute{Mine}, IsEdge: true},
        "2": {Id: "2", Biome: Field, Attributes: []Attribute{}, IsEdge: true},
        "3": {Id: "3", Biome: Hill, Attributes: []Attribute{Magic}, IsEdge: true},
        "4": {Id: "4", Biome: Forest, Attributes: []Attribute{Cave}, IsEdge: true},
        "5": {Id: "5", Biome: Field, Attributes: []Attribute{Magic}, IsEdge: true},
        "6": {Id: "6", Biome: Swamp, Attributes: []Attribute{}},
        "7": {Id: "7", Biome: Forest, Attributes: []Attribute{Cave}, IsEdge: true},
        "8": {Id: "8", Biome: Forest, Attributes: []Attribute{}},
        "9": {Id: "9", Biome: Forest, Attributes: []Attribute{Cave}, IsEdge: true},
        "10": {Id: "10", Biome: Mountain, Attributes: []Attribute{}, IsEdge: true},
        "11": {Id: "11", Biome: Field, Attributes: []Attribute{}, IsEdge: true},
        "12": {Id: "12", Biome: Field, Attributes: []Attribute{Magic}, IsEdge: true},
        "13": {Id: "13", Biome: Swamp, Attributes: []Attribute{}},
        "14": {Id: "14", Biome: Field, Attributes: []Attribute{Magic}},
        "15": {Id: "15", Biome: Mountain, Attributes: []Attribute{}, IsEdge: true},
        "16": {Id: "16", Biome: Water, Attributes: []Attribute{}, IsEdge: true},
        "17": {Id: "17", Biome: Hill, Attributes: []Attribute{}},
        "18": {Id: "18", Biome: Swamp, Attributes: []Attribute{Mine}, IsEdge: true},
        "19": {Id: "19", Biome: Water, Attributes: []Attribute{}, IsEdge: true},
        "20": {Id: "20", Biome: Hill, Attributes: []Attribute{}},
        "21": {Id: "21", Biome: Forest, Attributes: []Attribute{Cave}},
        "22": {Id: "22", Biome: Field, Attributes: []Attribute{Magic}, IsEdge: true},
        "23": {Id: "23", Biome: Field, Attributes: []Attribute{}, IsEdge: true},
        "24": {Id: "24", Biome: Field, Attributes: []Attribute{}, IsEdge: true},
        "25": {Id: "25", Biome: Hill, Attributes: []Attribute{}},
        "26": {Id: "26", Biome: Mountain, Attributes: []Attribute{Mine}},
        "27": {Id: "27", Biome: Swamp, Attributes: []Attribute{}, IsEdge: true},
        "28": {Id: "28", Biome: Swamp, Attributes: []Attribute{Mine}, IsEdge: true},
        "29": {Id: "29", Biome: Mountain, Attributes: []Attribute{}},
        "30": {Id: "30", Biome: Field, Attributes: []Attribute{}},
    ...
    tileMap["0"].AdjacentTiles = []*Tile{tileMap["2"], tileMap["6"], tileMap["13"], tileMap["14"], tileMap["25"]}
    tileMap["1"].AdjacentTiles = []*Tile{tileMap["20"], tileMap["23"], tileMap["27"]}
    tileMap["2"].AdjacentTiles = []*Tile{tileMap["0"], tileMap["4"], tileMap["6"], tileMap["13"], tileMap["23"]}
    tileMap["3"].AdjacentTiles = []*Tile{tileMap["15"], tileMap["16"], tileMap["28"], tileMap["30"]}
    tileMap["4"].AdjacentTiles = []*Tile{tileMap["2"], tileMap["13"], tileMap["24"], tileMap["26"]}
    tileMap["5"].AdjacentTiles = []*Tile{tileMap["8"], tileMap["20"], tileMap["27"], tileMap["28"], tileMap["29"], tileMap["30"]}
    tileMap["6"].AdjacentTiles = []*Tile{tileMap["0"], tileMap["2"], tileMap["8"], tileMap["14"], tileMap["20"], tileMap["21"], tileMap["23"], tileMap["29"]}
    tileMap["7"].AdjacentTiles = []*Tile{tileMap["10"], tileMap["11"], tileMap["22"], tileMap["25"], tileMap["26"]}
    tileMap["8"].AdjacentTiles = []*Tile{tileMap["5"], tileMap["6"], tileMap["20"], tileMap["29"]}
    tileMap["9"].AdjacentTiles = []*Tile{tileMap["12"], tileMap["18"], tileMap["31"]}
    tileMap["10"].AdjacentTiles = []*Tile{tileMap["7"], tileMap["12"], tileMap["19"], tileMap["25"]}
    tileMap["11"].AdjacentTiles = []*Tile{tileMap["7"], tileMap["22"]}
    tileMap["12"].AdjacentTiles = []*Tile{tileMap["9"], tileMap["10"], tileMap["19"], tileMap["25"], tileMap["31"]}
    tileMap["13"].AdjacentTiles = []*Tile{tileMap["0"], tileMap["2"], tileMap["4"], tileMap["25"], tileMap["26"]}
    tileMap["14"].AdjacentTiles = []*Tile{tileMap["0"], tileMap["6"], tileMap["15"], tileMap["21"], tileMap["25"], tileMap["31"]}
    tileMap["15"].AdjacentTiles = []*Tile{tileMap["3"], tileMap["14"], tileMap["17"], tileMap["18"], tileMap["21"], tileMap["30"], tileMap["31"]}
    tileMap["16"].AdjacentTiles = []*Tile{tileMap["3"], tileMap["28"]}
    tileMap["17"].AdjacentTiles = []*Tile{tileMap["15"], tileMap["21"], tileMap["29"], tileMap["30"]}
    tileMap["18"].AdjacentTiles = []*Tile{tileMap["9"], tileMap["15"], tileMap["31"]}
    tileMap["19"].AdjacentTiles = []*Tile{tileMap["10"], tileMap["12"]}
    tileMap["20"].AdjacentTiles = []*Tile{tileMap["1"], tileMap["5"], tileMap["6"], tileMap["8"], tileMap["23"], tileMap["27"]}
    tileMap["21"].AdjacentTiles = []*Tile{tileMap["6"], tileMap["14"], tileMap["15"], tileMap["17"], tileMap["29"]}
    tileMap["22"].AdjacentTiles = []*Tile{tileMap["7"], tileMap["11"], tileMap["24"], tileMap["26"]}
    tileMap["23"].AdjacentTiles = []*Tile{tileMap["1"], tileMap["2"], tileMap["6"], tileMap["20"]}
    tileMap["24"].AdjacentTiles = []*Tile{tileMap["4"], tileMap["22"], tileMap["26"]}
    tileMap["25"].AdjacentTiles = []*Tile{tileMap["0"], tileMap["7"], tileMap["10"], tileMap["12"], tileMap["13"], tileMap["14"], tileMap["26"], tileMap["31"]}
    tileMap["26"].AdjacentTiles = []*Tile{tileMap["4"], tileMap["7"], tileMap["13"], tileMap["22"], tileMap["24"], tileMap["25"]}
    tileMap["27"].AdjacentTiles = []*Tile{tileMap["1"], tileMap["5"], tileMap["20"]}
    tileMap["28"].AdjacentTiles = []*Tile{tileMap["3"], tileMap["5"], tileMap["16"], tileMap["30"]}
    tileMap["29"].AdjacentTiles = []*Tile{tileMap["5"], tileMap["6"], tileMap["8"], tileMap["17"], tileMap["21"], tileMap["30"]}
    tileMap["30"].AdjacentTiles = []*Tile{tileMap["3"], tileMap["5"], tileMap["15"], tileMap["17"], tileMap["28"], tileMap["29"]}
    tileMap["31"].AdjacentTiles = []*Tile{tileMap["9"], tileMap["12"], tileMap["14"], tileMap["15"], tileMap["18"], tileMap["25"]}
