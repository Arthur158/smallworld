...
var extensions = []ExtensionList{
    ...
    {
        Name:   "Underground",
        Races:  []string{"Gnomes", "Drows", "Cultists", "Flames", "Iron Dwarves", "Krakens", "Liches", "Lizardmen", "Shadow Mimes", "Mudmen", "Mummies", "Ogres", "Shrooms", "Spiderines", "Will-o'-Wisps"},
        Traits: []string{"Tomb", "Royal", "Immortal", "Wise", "Vanishing", "Reborn", "Flocking", "Adventurous", "Vampire", "Martyr", "Fisher", "Frightened", "Mining", "Mystic", "Stone", "Thieving", "Shield", "Quarreling"},
    },
    {
        Name:   "Cursed!",
