  ...
  return (
    <div className="p-4 border border-[#5F4B32] rounded bg-[#FDF5E6] shadow-md">
      ...
      <div className="grid grid-cols-2 gap-2 mt-4">
        <button onClick={handleDecline} className="w-full bg-[#8B4513] hover:bg-[#A0522D] text-white py-2 px-3 rounded transition-colors">
          Decline <span className="text-sm text-gray-300">(D)</span>
        </button>
        <button onClick={handleRedeploy} className="w-full bg-[#8B4513] hover:bg-[#A0522D] text-white py-2 px-3 rounded transition-colors">
          Redeploy <span className="text-sm text-gray-300">(R)</span>
        </button>
        <button onClick={handleEndTurn} className="w-full bg-[#8B4513] hover:bg-[#A0522D] text-white py-2 px-3 rounded transition-colors">
          End Turn <span className="text-sm text-gray-300">(E)</span>
        </button>
